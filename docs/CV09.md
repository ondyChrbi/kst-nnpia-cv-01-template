...
Cílem cvičení je seznámit studenty s užitečnými knihovnami pro React.js pro vytváření formulářů.
...
- Vytvořte formulář pro přidání uživatele.
    - Formulář vytvořte jako samostatnou komponentu a umístěte jí do `App.tsx`.
...
- Vytvořte dvě nové stránky.
    - První stránka bude obsahovat formulář pro přidání uživatele.
      - Formulář bude dostupný pod URL `/users/add-user`.
    - Druhá stránka bude obsahovat seznam uživatelů.
